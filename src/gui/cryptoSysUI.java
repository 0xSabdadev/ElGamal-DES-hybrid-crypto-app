...
/**
 * GUI interface for cryptosystem application.
 * 
 * @author Zaylin
 */
public class cryptoSysUI extends javax.swing.JFrame {

    /**
     * Creates new form cryptoSysUI
     */
    public cryptoSysUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        decTabPanelLayout
                .setHorizontalGroup(decTabPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(decTabPanelLayout.createSequentialGroup()
                                .addGroup(decTabPanelLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(decTabPanelLayout.createSequentialGroup().addGap(266, 266, 266)
                                                .addComponent(bDecMsg).addGap(26, 26, 26).addComponent(bDecExit))
                                        .addGroup(decTabPanelLayout.createSequentialGroup().addGap(73, 73, 73)
                                                .addGroup(decTabPanelLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                        .addComponent(lDecCipher).addComponent(lDecMsg))
                                                .addGap(46, 46, 46)
                                                .addGroup(decTabPanelLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        decTabPanelLayout.setVerticalGroup(decTabPanelLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(decTabPanelLayout.createSequentialGroup().addGap(30, 30, 30)
                        .addGroup(decTabPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(lDecCipher).addComponent(jScrollPane2,
                        ...
                        .addGroup(decTabPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(bDecMsg).addComponent(bDecExit))
                        .addGap(63, 63, 63)));
        ...
        encTabPanelLayout
                .setHorizontalGroup(encTabPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(encTabPanelLayout.createSequentialGroup()
                                .addGroup(encTabPanelLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(encTabPanelLayout.createSequentialGroup().addGap(263, 263, 263)
                                                .addComponent(bEncMsg).addGap(44, 44, 44).addComponent(bEncExit))
                                        .addGroup(encTabPanelLayout.createSequentialGroup().addGap(60, 60, 60)
                                                .addGroup(encTabPanelLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                        .addComponent(lEncMsg).addComponent(lEncCipTxt))
                                                .addGap(52, 52, 52)
                                                .addGroup(encTabPanelLayout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                                                false)
                                                        .addComponent(jScrollPane3,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE, 454,
                                                                Short.MAX_VALUE)
                                                        .addComponent(jScrollPane1))))
                                .addContainerGap(230, Short.MAX_VALUE)));
        encTabPanelLayout.setVerticalGroup(encTabPanelLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, encTabPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(encTabPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(bEncMsg).addComponent(bEncExit))
                        .addGap(57, 57, 57)));
        ...
        pSecretKeyLayout.setHorizontalGroup(pSecretKeyLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(pSecretKeyLayout.createSequentialGroup().addGap(46, 46, 46)
                        .addComponent(lSecKey, javax.swing.GroupLayout.PREFERRED_SIZE, 182,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(35, 35, 35)
                        .addGroup(pSecretKeyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(pSecretKeyLayout.createSequentialGroup().addGap(32, 32, 32)
                                        .addComponent(bSecKey).addGap(40, 40, 40).addComponent(bSecKeyExit))
                                .addComponent(pwSecMsg, javax.swing.GroupLayout.PREFERRED_SIZE, 483,
                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap(133, Short.MAX_VALUE)));
        pSecretKeyLayout.setVerticalGroup(pSecretKeyLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(pSecretKeyLayout.createSequentialGroup().addGap(175, 175, 175)
                        .addGroup(pSecretKeyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(pwSecMsg, javax.swing.GroupLayout.PREFERRED_SIZE, 44,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(lSecKey, javax.swing.GroupLayout.PREFERRED_SIZE, 46,
                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(127, 127, 127)
                        .addGroup(pSecretKeyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(bSecKey).addComponent(bSecKeyExit))
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup().addContainerGap()
                        .addComponent(tabPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 884,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout
                        .createSequentialGroup().addContainerGap().addComponent(tabPanel,
    ...
    private void bEncMsgActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bEncMsgActionPerformed
        // TODO add your handling code here:
    }// GEN-LAST:event_bEncMsgActionPerformed

    private void bDecMsgActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bDecMsgActionPerformed
        // TODO add your handling code here:
    }// GEN-LAST:event_bDecMsgActionPerformed

    private void bEncExitActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bEncExitActionPerformed
        // TODO add your handling code here:
        System.exit(0);
    }// GEN-LAST:event_bEncExitActionPerformed

    private void bDecExitActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bDecExitActionPerformed
        // TODO add your handling code here:
        System.exit(0);
    }// GEN-LAST:event_bDecExitActionPerformed

    private void bDecExitMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_bDecExitMouseClicked
        // TODO add your handling code here:
        System.exit(0);
    }// GEN-LAST:event_bDecExitMouseClicked

    private void bEncExitMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_bEncExitMouseClicked
        // TODO add your handling code here:
        System.exit(0);
    }// GEN-LAST:event_bEncExitMouseClicked

    private void bEncMsgMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_bEncMsgMouseClicked
        // TODO add your handling code here:
        String msg = taEncMsg.getText();
        String pw = Arrays.toString(pwSecMsg.getPassword());
        encryptMessage(msg, pw, taEncCipTxt);
    }// GEN-LAST:event_bEncMsgMouseClicked

    private void bDecMsgMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_bDecMsgMouseClicked
        // TODO add your handling code here:
        String msg = taDecCipher.getText();
        decryptMessage(msg, taDecMsg);
    }// GEN-LAST:event_bDecMsgMouseClicked

    private void formWindowOpened(java.awt.event.WindowEvent evt) {// GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
    }// GEN-LAST:event_formWindowOpened

    private void pwSecMsgActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_pwSecMsgActionPerformed
        // TODO add your handling code here:
    }// GEN-LAST:event_pwSecMsgActionPerformed

    private void bSecKeyExitMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_bSecKeyExitMouseClicked
        // TODO add your handling code here:
        System.exit(0);
    }// GEN-LAST:event_bSecKeyExitMouseClicked

    private void bSecKeyExitActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bSecKeyExitActionPerformed
        // TODO add your handling code here:
    }// GEN-LAST:event_bSecKeyExitActionPerformed

    private void bSecKeyMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_bSecKeyMouseClicked
        // TODO add your handling code here:
        key.updateSecretMsg(Arrays.toString(pwSecMsg.getPassword()));
        System.out.println("Secret Message Updated");
    }// GEN-LAST:event_bSecKeyMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cryptoSysUI.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
     ...
     * @param cipher text area object to update with the encrypted message.
     */
     ...
     * @param msg text area object to update with decrypted message.
     */
