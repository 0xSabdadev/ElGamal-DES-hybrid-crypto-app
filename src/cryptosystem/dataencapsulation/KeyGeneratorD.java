...
/**
 * Class for key schedule of DES for encryption/decryption.
 * 
 * @author Zaylin Arata
 */
public class KeyGeneratorD {
    /**
     * Constructor of KeyGenerator object.
     * 
     * @param s key string.
     */
     ...
     * Encoding shifts.
     * 
     * @param PC1 char[] of PC1 permutation.
     */
     ...
     * 
     * @return Array of decryption keys.
     */
    ...
    private final int[] PC_1 = { 57, 49, 41, 33, 25, 15, 9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 27, 19,
            11, 3, 60, 52, 44, 36, 63, 55, 47, 39, 31, 23, 15, 7, 62, 54, 46, 38, 30, 22, 14, 6, 61, 53, 45, 37, 29, 21,
            13, 5, 28, 20, 12, 4 };
    private final int[] PC_2 = { 14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10, 23, 19, 12, 4, 26, 8, 16, 7, 27, 20, 13, 2,
