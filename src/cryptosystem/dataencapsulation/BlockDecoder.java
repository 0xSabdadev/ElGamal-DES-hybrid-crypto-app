...
/**
 * Class to decode 64 bits blocks using DES.
 * 
 * @author Zaylin Arata
 */
public class BlockDecoder {
     ...
     * @return a hex string of plaintext.
     */
    public String decodeBlock(String s) {
        ...
        for (int i = 15; i > -1; i--) {
            R[i] = L[i + 1];
            // do R expansion
            String exp = expansion(L[i + 1].toCharArray());
            // do XOR of Key and R
            String xor = myXOR(exp, K[i + 1]);
    ...
    /**
     * Constructor for BlockDecoder class.
     * 
     * @param arr keys array.
     */
    public BlockDecoder(String[] arr) {
        K = arr;
    }
